...
export default function EnglishLearningServices() {
  return (
    <SiteLayout
      title="eigo base・スタディサプリENGLISH・Camblyの使い分け | eigo base"
      description="eigo base、スタディサプリENGLISH、Camblyの得意分野、向いている人、TOEIC学習と英会話実践での使い分けを比較します。"
    >
      <article className={styles.article}>
        <p className={styles.kicker}>比較ガイド</p>
        <h1>eigo base・スタディサプリENGLISH・Camblyの使い分け</h1>
        <p>
          英語学習サービスは、それぞれ得意分野が違います。
          単語や文法を毎日少しずつ復習したい人、TOEICスコアを上げたい人、ネイティブ講師と会話したい人では、
          選ぶべきサービスも使い方も変わります。
          ここでは、eigo base、スタディサプリENGLISH、Camblyを、学習目的に合わせてどう使い分けるかを整理します。
        </p>
        ...
        <section>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 640 }}>
              ...
              <tbody>
                <tr>
                  <td style={{ borderBottom: '1px solid #e2e8f0', padding: 10 }}>eigo base</td>
        ...
        <section>
          <h2>eigo baseは毎日の学習を始める場所</h2>
          <p>
            eigo baseは、英語学習を始める手間を減らすためのサービスです。
        ...
        <section>
          ...
          <p>
            eigo baseで毎日の単語・文法確認を行い、スタディサプリENGLISHで講義と演習を進めると、
          ...
          <AffiliateCard
            ...
            variant="compact"
            urlKey="toeic"
            reason="TOEIC対策を講義と演習で整理したい人に向いています。eigo baseで基礎確認、スタディサプリで本格対策という流れを作れます。"
          />
        </section>
        ...
        <section>
          ...
          <p>
            AI英会話で表現を試し、Camblyで講師と話し、言えなかった表現をeigo baseへ戻す。
        ...
        <section>
          ...
          <p>
            まずeigo baseで単語とPart5を短く回し、頻出語と基本文法の抜けを減らします。
            そのうえで、スタディサプリENGLISHの講義や演習を使い、出題形式ごとの解き方を整理すると進めやすくなります。
          </p>
          <h3>TOEIC800点を目指す人</h3>
          <p>
            弱点分析と復習の質が重要になります。eigo baseでミスした単語や文法を残し、
            スタディサプリENGLISHや公式問題集で本番形式の演習を行うと、短い復習と実戦練習を両立できます。
          </p>
          <h3>英会話を伸ばしたい人</h3>
          <p>
            eigo baseのAI英会話で表現を準備し、Camblyで実際に話す流れがおすすめです。
