  ...
  return (
    ...
    >
      <article className={styles.article}>
        ...
        <section>
          <h2>外部サービスとアフィリエイトリンク</h2>
          <p>
            本サービスでは、Google、Supabase、YouTube、広告配信サービス、アクセス解析サービス、
            アフィリエイトサービスなどの外部サービスを利用する場合があります。
            外部リンク先で提供される商品、サービス、情報、料金、キャンペーン等については、
            各提供元の規約および表示をご確認ください。
          </p>
          <p>
            本サイトにはA8.net等のアフィリエイトリンクが含まれる場合があります。
            アフィリエイトリンク経由で申し込みが行われた場合、本サイトが成果報酬を受け取ることがありますが、
            掲載内容は英語学習者に役立つ情報提供を目的としています。
          </p>
        </section>
